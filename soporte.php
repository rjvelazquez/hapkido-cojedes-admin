    ...
    ?>
          	...
          	<div class="box-shadow">
            	<div class="wrap block-2">
                    ...
                    <div class="col-4">
                    	<h2><span class="color-1">Envianos un mail</span> con gusto responderemos</h2>
                        <form action="send.php" id="form" method="post" >
                            <fieldset>
                              <label><input type="text" name="name" value="Nombre y Apellido" onBlur="if(this.value=='') this.value='Nombre y Apellido'" onFocus="if(this.value =='Nombre y Apellido' ) this.value=''"></label>
                              ...
                              <div class="btns"><a class="button" onClick="document.getElementById('form').submit()">Enviar</a></div>
                            </fieldset>  
                          </form> 
                    </div>
                </div>
